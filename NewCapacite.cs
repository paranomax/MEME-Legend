...
namespace JeuxVideo_MemeLegend
{
    public class NewCapacite
    {
        ...
        public NewCapacite(string Nom, string Type, int Puissance, int IDEffet, bool NoSp, int ID)
        {
            IDtech = ID;
            this.Nom = Nom;
            this.Type = Type;
        ...
        public int genererdegat(NewCreature j1, NewCreature j2)
        {
            int degats = 0;
            if (NoSp == false)
            {
        ...
        public void AppliquerEffet(NewCreature J1, NewCreature J2, TextBox boite, Socket sClient)
        {
            switch (IDEffet)
            {
                case 1://buff def -15pv
                    ModifierStat(J1, "Def", 40);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Def/40/"));
                    boite.Text = "la défense de " + J1.Nom + " augmente de 40.";
                    sClient.Send(Encoding.Unicode.GetBytes("m/"+ boite.Text+"/"));
                    MajBoite(boite, sClient);

                    J1.HP -= 15;
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/HP/-15/"));
                ...
                case 2: //buff attaque - 15pv
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/AttSpec/40/"));
                ...
                case 3://buff 50 att/spec -30 def rageon
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Att/40/"));
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/DeffSpec/-25/"));
                ...
                case 4: // j2 -30 att
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/Att/-30/"));
                ...
                case 5: // invest
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/AttSpec/30/"));
                ...
                case 6://meteor
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/AttSpec/-20/"));
                ...
                case 7:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/AttSpec/10/"));
                    ModifierStat(J1, "Att", 10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Att/10/"));
                    ModifierStat(J1, "Def", 10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Def/10/"));
                    ModifierStat(J1, "DefSpec", 10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/DefSpec/10/"));

                    ModifierStat(J2, "AttSpec", 10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/AttSpec/10/"));
                    ModifierStat(J2, "Att", 10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/Att/10/"));
                    ModifierStat(J2, "Def", 10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/Def/10/"));
                    ModifierStat(J2, "DefSpec", 10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/DefSpec/10/"));
                ...
                case 8://feat
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Def/20/"));
                ...
                case 9:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/Def/-20/"));
                ...
                case 10:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Att/25/"));
                ...
                case 11:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Def/-15/"));
                    ModifierStat(J1, "DefSpec", -15);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/DefSpec/-15/"));
                ...
                case 12:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/AttSpec/-15/"));
                    ModifierStat(J2, "Att", -15);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/Att/-15/"));
                ...
                case 13:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Att/30/"));
                    boite.Text = J1.Nom + " augmente son attaque de 30.";
                    sClient.Send(Encoding.Unicode.GetBytes("m/" + boite.Text + "/"));
                    MajBoite(boite, sClient);
                    break;
                ...
                case 17:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/HP/65/"));
                ...
                case 18:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Att/20/"));
                    ModifierStat(J1, "Def", -10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/Def/-10/"));
                    ModifierStat(J1, "DefSpec", -10);
                    sClient.Send(Encoding.Unicode.GetBytes("stat/1/DefSpec/-10/"));
                ...
                case 19:
                    ...
                    sClient.Send(Encoding.Unicode.GetBytes("stat/2/Def/-15/"));
        ...
        private void MajBoite(TextBox boite, Socket sClient)
        {
            boite.Refresh();
        ...
        public void ModifierStat(NewCreature J1, string stat, int modif)
        {
            switch (stat)
            {
                case "Att":
